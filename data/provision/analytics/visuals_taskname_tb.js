...
var visuals = [
	{
		...
		"_source": {
			...
			"title": "System load",
			"version": 1,
			"savedSearchId": "System-stats-%taskName%",
	...
	},
	{
		...
		"_source": {
			...
			"uiStateJSON": "{}",
			"version": 1,
			"savedSearchId": "Proc-stats-%taskName%",
			"kibanaSavedObjectMeta": {
				"searchSourceJSON": "{\"filter\":[]}"
			}
		}
	...
	{
		"id": "CPU-usage-per-process-%taskName%",
		"_type": "visualization",
		"_shipper": "topbeat",
		"_service": "service",
		"_injector": "taskname",
	...
	{
		"id": "Memory-usage-per-process-%taskName%",
		"_type": "visualization",
		"_shipper": "topbeat",
		"_service": "service",
		"_injector": "taskname",
	...
	{
		"id": "Disk-utilization-over-time-%taskName%",
		"_type": "visualization",
		"_shipper": "topbeat",
		"_service": "service",
		"_injector": "taskname",
		"_source": {
			...
			"uiStateJSON": "{}",
			"version": 1,
			"savedSearchId": "Filesystem-stats-%taskName%",
			"kibanaSavedObjectMeta": {
				"searchSourceJSON": "{\"filter\":[]}"
			}
		}
	...
	{
		"id": "Disk-usage-overview-%taskName%",
		"_type": "visualization",
		"_shipper": "topbeat",
		"_service": "service",
		"_injector": "taskname",
